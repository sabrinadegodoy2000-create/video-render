...
if (referenciaMode) {
  ...
  // montado pelo painel. Cada item já traz src (nome do arquivo no release), tipo, duração e,
  // pros trechos NÃO trocados, o startSec (fatia do vídeo de referência fonte.mp4). A narração
  // manda na duração — se o visual passar dela, o excedente é cortado no fim pela composição.
